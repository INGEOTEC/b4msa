...
class TextModel(mTCTextModel):
    ...
    def default_parameters(self, lang=None):
        ...
        {'token_list': [[3, 1], [2, 1], -3, -1, 3, 4], 'num_option': 'delete', 'negation': False, 'stemming': False, 'stopwords': 'none'}
        ...
        if lang == 'spanish':
            ...
            return dict(token_list=[[3, 1], [2, 1], -3, -1, 3, 4], num_option='delete', negation=False, stemming=False, stopwords=OPTION_NONE)
        elif lang == 'arabic':
